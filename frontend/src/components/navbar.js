        ...
        <div className="flex h-16 items-center">
          ...
          <div className="flex-none">
            <Link to="/" className="flex items-center text-gray-800 transition hover:text-gray-500/75">
              <img
                src="../../static/images/home.jpg" // Replace with your actual home icon URL
                alt="Home"
            ...
            <nav aria-label="Global">
              <ul className="flex items-center gap-4 text-base sm:text-sm md:text-lg">
                ...
                <li>
                  <a
                    className="text-gray-800 transition hover:text-gray-500/75"
                    onClick={() => scrollToSection('college-card')}
                    style={{ cursor: 'pointer' }}
                  >
                    Explore College
                  </a>
                ...
                <li>
                  <a className="text-gray-800 transition hover:text-gray-500/75" href="#">
                    Careers
                  </a>
                </li>
              </ul>
